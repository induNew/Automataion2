...
//	File ff = new File("./Website5/Facebook" + count + ".png");
//	Files.copy(sc, ff);
//	count++;
//}
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		jse.executeScript("document.getElementByID('email').value=('sawantsuraj743@gmail.com')");
